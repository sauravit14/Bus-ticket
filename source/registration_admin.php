<?php
    if(isset($_POST['sub']))
    {
		...
		{
            if($v3==$row['admin_uname'] || $v4==$row['pno'])
            {
                $flag=1;
            }
        }           
        ...
        {
            $sql="insert into adminreg(fname,lname,admin_uname,pno,pass,address,city,pcode,sque1) values ('".$v1."','".$v2."','".$v3."','".$v4."','".$v5."','".$v6."','".$v7."','".$v8."','".$v9."')";
         ...
         <div class="detaildiv2">
             ...
             <center>
               ...
               <tr> <th>City :</th>
                    ...
                    <tr>
                      <th>Your Nationality :</th><td>   <input type="text" name="sque1" id="sque1" ></td>
                    </tr>
              	<tr>
